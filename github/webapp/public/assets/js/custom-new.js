...
/** Main search */
$(document).on('keyup', '#search-key', function (event) {
...
$("body").click(function(e){
  ...
  // CREATE POST TAB BTN
  $(".tab-next-btn").click(function(e){
    e.preventDefault();
    $(this).parents(".tab-pane").removeClass("show active");
    $(this).parents(".tab-pane").next().addClass("show active");
    let selected_tab = $(".profile-tab-wrap .nav-item .nav-link.active");
    selected_tab.parent().next().children().addClass("active");
    selected_tab.removeClass("active");
  })
  
  
  //PRODUCT DETAIL SLIDER
  var swiper = new Swiper(".product-det-slider", {
    spaceBetween: 10,
    loop: true,
    speed: 1500,
    autoplay: {
    ...
    navigation: {
      nextEl: ".product-det-slider .swiper-button-next",
      prevEl: ".product-det-slider .swiper-button-prev",
    },
  });
