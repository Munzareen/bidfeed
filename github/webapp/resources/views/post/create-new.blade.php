						...
						<div class="post-img-right">
							<div class="containing-div">
								<div class="post-right-top post-user-wrap">
									<div class="post-user">
										<div class="img">
											<img src="assets/images/user-review-img.png" alt="img" class="img-fluid">
										</div>
								...
								<div class="post-right-bottom">
									...
									<button class="post-btn post-btn-2 tab-next-btn">Post Now</button>
								</div>
							</div>
						</div>
					</div>
...
@push('scripts')
    ...
    <script>
        // POSTING GIF FUNTION
        let gifNextBtn = document.querySelector(".post-gif-wrap .next-btn");
        let postGifStep1 = document.querySelector(".post-gif-wrap");
        let postGifStep2 = document.querySelector(".posting-gif-wrap");
        gifNextBtn.onclick = function() {
        postGifStep1.style.display = "none";
        postGifStep2.style.display = "block";
        };
    </script>
@endpush
