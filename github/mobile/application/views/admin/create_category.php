                                  ...
                                  <div class="card-body">
                                      <form method="post">
                                          <div class="form-group">
                                              ...
                                              <input id="category_name" name="cc-payment" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                          </div>
                                          <div>
                                              <button id="submit_category" type="submit" class="btn btn-lg btn-info btn-block">
